...
names = os.listdir('habitat-challenge-data/objectnav_mp3d_v1/train/content/')
n_ep_per_class = 4096
...
for i, scene_name in enumerate(names):
    ...
    path='habitat-challenge-data/objectnav_mp3d_v1/train/content/'+scene_name
...
for i, scene_name in enumerate(names):
    ...
    path='habitat-challenge-data/objectnav_mp3d_v1/train/content/'+scene_name
    path_new='habitat-challenge-data/objectnav_mp3d_v1/train_small/content/'+scene_name
