...
mp3d_2021_dataset = dataset_base.copy({
    'name': 'Matterport3D-Habitat-challenge-2021',

    # 'train_images': '../habitat-challenge-data/mp3d_2021_coco_style/',
    # # 'valid_images': '../habitat-challenge-data/mp3d_2021_coco_style/',
    # 'valid_images': '../habitat-challenge-data/mp3d_2021_coco_style/0/val/',
    #
    # 'train_info': '../habitat-challenge-data/mp3d_2021_coco_style/mp3d_2021_coco_style_train.json',
    # # 'valid_info': '../habitat-challenge-data/mp3d_2021_coco_style/mp3d_2021_coco_style_val.json',
    # 'valid_info': '../habitat-challenge-data/mp3d_2021_coco_style/0/val/mp3d_2021_coco_style.json',

    # 'train_images': '../habitat-challenge-data/0/train/',
    # 'valid_images': '../habitat-challenge-data/0/val/',
    #
    # 'train_info': '../habitat-challenge-data/0/train/mp3d_2021_coco_style.json',
    # 'valid_info': '../habitat-challenge-data/0/val/mp3d_2021_coco_style.json',

    'train_images': '../habitat-challenge-data/mp3d_2021_coco_style/viewpoints_train/',
    'valid_images': '../habitat-challenge-data/mp3d_2021_coco_style/viewpoints_train/',

    'train_info': '../habitat-challenge-data/mp3d_2021_coco_style/viewpoints_train/mp3d_2021_coco_style_train.json',
    'valid_info': '../habitat-challenge-data/mp3d_2021_coco_style/viewpoints_train/mp3d_2021_coco_style_train.json',

    'class_names': MP3D_2021_CLASSES,
})
################################################################################
...
yolact_plus_resnet50_mp3d_2021_config = yolact_plus_resnet50_config.copy({
    # Dataset stuff
    'dataset': mp3d_2021_dataset,
    'num_classes': len(mp3d_2021_dataset.class_names) + 1,
    ...
    # # Training params
    # #My dataset is roughtly 2.5 larger than coco so scale the iterations
    # 'lr_steps': ( int(np.round(280000*(1/5) )), int(np.round(600000*(1/5))), int(np.round(700000*(1/5))), int(np.round(750000*(1/5))) ),
    # 'max_iter': int(np.round(800000*(1/5))),

    # Training params
    #My dataset is roughtly 2.5 larger than coco so scale the iterations
    'lr_steps': ( int(np.round(280000*(1/5) )), ),
    'max_iter': int(np.round(800000*(1/5)*2) ),

    #set 0 only is 165341, roughly half of coco, which is 330k
    # 'lr_steps': ( int(np.round(280000*0.5)), int(np.round(600000*0.5)), int(np.round(700000*0.5)), int(np.round(750000*0.5)) ),
    # 'max_iter': int(np.round(800000*0.5)),
})
